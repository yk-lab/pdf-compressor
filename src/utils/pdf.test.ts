...
import { renderPdfToCanvases, mergePdfFiles, createCompressedPdfFromImages, PDFCompressionSizeError } from './pdf';
...
describe('PDF Utilities', () => {
  ...
  describe('createCompressedPdfFromImages', () => {
    it('should throw PDFCompressionSizeError when cannot compress below limit', async () => {
      ...
      const largeJpegBase64 = 'data:image/jpeg;base64,' + 'A'.repeat(10000) + '//Z';
      const mockCanvas = {
